...
SineWaveGenerator.prototype.strokeStyle  = 'rgba(192, 222, 255, 0.9)';
...
SineWaveGenerator.prototype._resizeWidth = function() {
  ...
  this.waveWidth = this.width * 0.35;
  this.waveLeft = this.width * 0.00;
}
...
//       strokeStyle: 'rgba(255, 255, 255, 0.1)'
  ...
  resizeEvent: function() {
    ...
    gradient.addColorStop(0,"rgba(192, 222, 255, 0.9)");
    gradient.addColorStop(0.5,"rgba(254, 205, 254, 0.9)");
    gradient.addColorStop(1,"rgba(192, 222, 255, 0.9)");
